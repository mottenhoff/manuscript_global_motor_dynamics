...
def explore(session, savepath):
    ...
    if c.explore.pca:
        ...
        with open(savepath/session.kh_id/f'processed_data.npy', 'wb') as f:
            np.save(f, session.trials)

        # with open(savepath/session.kh_id/f'full_principal_axes.npy', 'wb') as f:
        #     np.save(f, pca.components_)

        with open(savepath/session.kh_id/f'full_explained_variance.npy', 'wb') as f:
        ...
        with open(savepath/session.kh_id/f'labels.npy', 'wb') as f:
