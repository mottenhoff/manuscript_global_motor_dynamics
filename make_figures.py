...
# # from libs.figures.figure_6 import make as make_fig_6
# from libs.figures.plot_raw import make as make_fig_6
...
def make_all(path):
    ...
    # make_fig_6(path/'full_run')               # Signal characterization
    # make_fig_6(path/'full_run')
